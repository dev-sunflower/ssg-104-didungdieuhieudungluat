      ...
      <div className="overflow-hidden rounded-3xl border border-[#1E1E1E]/10 bg-white/88 shadow-[0_18px_40px_rgba(30,30,30,0.12)] backdrop-blur-sm">
        ...
        <div className="p-9">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-3xl font-extrabold text-[#1E1E1E]" style={{ fontFamily: 'var(--font-caveat)' }}>Đăng ký tài khoản</h1>
          ...
          {sent ? (
            <div className="rounded-2xl bg-[linear-gradient(145deg,#FFF4D6,#FFE8A8)] py-6 px-4 text-center">
              ...
              <h2 className="mb-2 text-xl font-bold text-[#1E1E1E]" style={{ fontFamily: 'var(--font-caveat)' }}>Xác nhận email!</h2>
          ...
          <p className="mt-6 text-center text-[0.75rem] text-text-tertiary">
            Đã có tài khoản?{' '}
            <Link href="/auth/login" className="font-medium text-[#F4A616] transition-colors hover:text-[#e59b11]">Đăng nhập</Link>
          </p>
        </div>
      </div>
    </div>
