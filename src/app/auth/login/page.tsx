        ...
        <div className="p-9">
          <div className="mb-8 text-center">
            <div className="mb-4 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-[#F4A616]">
              <span className="text-xl font-medium text-[#1E1E1E]" style={{ fontFamily: 'var(--font-caveat)' }}>S</span>
            </div>
            <h1 className="text-3xl font-extrabold text-[#1E1E1E]" style={{ fontFamily: 'var(--font-caveat)' }}>SSG104</h1>
          ...
          {sent ? (
            <div className="rounded-2xl bg-[linear-gradient(145deg,#FFF4D6,#FFE8A8)] py-6 px-4 text-center">
              ...
              <h2 className="mb-2 text-xl font-bold text-[#1E1E1E]" style={{ fontFamily: 'var(--font-caveat)' }}>Kiểm tra email!</h2>
          ...
          <p className="mt-6 text-center text-[0.75rem] text-text-tertiary">
            Chưa có tài khoản?{' '}
            <Link href="/auth/signup" className="font-medium text-[#F4A616] transition-colors hover:text-[#e59b11]">Đăng ký miễn phí</Link>
          </p>
          <div className="mt-4 border-t border-[#1E1E1E]/10 pt-4 text-center">
            <Link href="/landing" className="text-sm text-text-tertiary transition-colors hover:text-text-secondary">← Tiếp tục không cần đăng nhập</Link>
          </div>
        </div>
      </div>
    </div>
