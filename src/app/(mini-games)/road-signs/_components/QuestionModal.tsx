...
export default function QuestionModal({ question, onAnswer }: Props) {
  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center p-3 overflow-y-auto">
      <div className="w-full max-w-md rounded-3xl border-2 border-[#F4A616]/30 bg-white/95 p-5 shadow-2xl backdrop-blur-[2px]">
